...
cd "$ROOT"
"$PYTHON" data_pipeline/blender/scripts/monitor_repair_campaign.py \
...
"$PYTHON" data_pipeline/blender/scripts/prepare_continued_campaign.py \
  --first-campaign "$BASE" \
...
"$PYTHON" data_pipeline/blender/scripts/cleanup_continued_campaign.py \
